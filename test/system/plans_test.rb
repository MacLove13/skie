...
class PlansTest < ApplicationSystemTestCase
  ...
  test "should create plan" do
    ...
    fill_in "Annual retention", with: @plan.annual_retention
    fill_in "Daily retention", with: @plan.daily_retention
    fill_in "Description", with: @plan.description
    fill_in "Monthly retention", with: @plan.monthly_retention
